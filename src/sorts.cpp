...
string dataset[] =
{ 
"Almost_50.txt","Almost_100.txt","Almost_500.txt","Almost_1000.txt",          //
"Almost_5000.txt","Almost_10000.txt","Almost_50000.txt",                      //
"Almost_100000.txt","Almost_500000.txt","Almost_1000000.txt",                 //
"Sorted_50.txt","Sorted_100.txt","Sorted_500.txt","Sorted_1000.txt",          //
"Sorted_5000.txt","Sorted_10000.txt","Sorted_50000.txt",                      //
"Sorted_100000.txt","Sorted_500000.txt","Sorted_1000000.txt",                 //
"Random_50.txt","Random_100.txt","Random_500.txt","Random_1000.txt",          //   Names of the dataset files.
"Random_5000.txt","Random_10000.txt","Random_50000.txt","Random_100000.txt",  //
"Random_500000.txt","Random_1000000.txt","Reverse_50.txt",                    //
"Reverse_100.txt","Reverse_500.txt","Reverse_1000.txt","Reverse_5000.txt",    //
"Reverse_10000.txt","Reverse_50000.txt","Reverse_100000.txt",                 //
"Reverse_500000.txt","Reverse_1000000.txt","Small_range_50.txt",              //
"Small_range_100.txt","Small_range_500.txt","Small_range_1000.txt",           //
"Small_range_5000.txt","Small_range_10000.txt","Small_range_50000.txt",       //
...
double time_sort_hi_low(void (*f)(int ar[], int l, int h),int arr[], int low, int high) // Timing function for quicksort/mergesort
{
    auto t1 = steady_clock::now();
    f(arr,low,high);
    auto t2 = steady_clock::now();
    auto d1 = duration_cast<nanoseconds>(t2 - t1);
    return (double)d1.count();  // The casting doesn't affect the precision
}
double time_sort_size(void (*f)(int ar[], int size), int arr[], int size)  // Timing function for the rest of the sorts
{
    auto t1 = steady_clock::now();
    f(arr, size);
    auto t2 = steady_clock::now();
...
void quick_sort(int arr[], int l, int h) // ! ITERATIVE QUICKSORT
{
